    ...
    <div className="sm:w-auto lg:w-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="text-white font-bold bg-mainColor hover:bg-mainColor/50  focus:outline-none focus:bg-mainColor/25  rounded-lg text-lg px-6 py-4 text-center">
            اضف الى السلة
          </button>
        </div>
      </div>
